...
//            if((this.motorista.getIdade()<18)||(this.motorista.getPontos()>20)||(this.motorista.getHabilitacao()==null)){
//                throw new NullPointerException("Problema com o motorista");
//            }
            if((this.placa==null) || (this.cor==null) ){
                throw new NullPointerException("Problema com carro");
            }
//            if(idade<18){
//                throw new NullPointerException("Menor de idade");
//
//            }
